...
import com.android.settings.widget.CustomSeekBarPreference;
...
public class SmartChargingSettings extends DashboardFragment implements OnPreferenceChangeListener {
    ...
    private static final String KEY_FOOTER_PREFERENCE = "smart_charging_detail_footer";
    ...
    public void onCreate(Bundle icicle) {
        ...
        mFooterText =  new SpannableStringBuilder(getText(R.string.smart_charging_footer));
